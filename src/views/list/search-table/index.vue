<template>
  <div class="container">
    ...
    <a-card class="general-card" :title="$t('menu.list.searchTable')">
      ...
      <a-table row-key="id" :loading="loading" :scroll="{ minWidth: 1000 }" :pagination="pagination" :columns="(cloneColumns as TableColumnData[])" :data="renderData" :bordered="false" :size="size" @page-change="onPageChange">
