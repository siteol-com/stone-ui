export default {
  ...
  'settings.navbar.theme.toLight': '亮色模式',
  'settings.navbar.theme.toDark': '暗黑模式',
  'settings.navbar.screen.toFull': '全屏展示',
  'settings.navbar.screen.toExit': '浏览器访问',
  ...
  'settings.colorWeak.in': '色弱模式',
  'settings.colorWeak.out': '色彩模式',
