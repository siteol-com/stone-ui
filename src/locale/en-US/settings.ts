export default {
  ...
  'settings.navbar.theme.toLight': 'Light mode',
  'settings.navbar.theme.toDark': 'Dark mode',
  'settings.navbar.screen.toFull': 'Full Screen',
  'settings.navbar.screen.toExit': 'Browser View',
